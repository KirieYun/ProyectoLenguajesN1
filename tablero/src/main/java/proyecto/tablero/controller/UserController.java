...
public class UserController {
    ...
    public User addUser(@RequestParam String correo, @RequestParam String contraseña, @RequestParam String Nombre,
    ...
    @PostMapping("/{id}")
    public User update(@PathVariable int id, @RequestParam String correo, @RequestParam String contraseña,
            @RequestParam String Nombre, @RequestParam(required = false) MultipartFile file) {
